...
void setup_scr_setting_screen(lv_ui *ui)
{
    ...
    ui->setting_screen_list_1_item1 = lv_list_add_btn(ui->setting_screen_list_1, &_OTA_alpha_30x30, "  WIFI");
    ...
    lv_style_set_text_font(&style_setting_screen_list_1_extra_btns_main_default, &lv_font_montserratMedium_14);
    ...
    lv_style_set_text_font(&style_setting_screen_list_1_extra_texts_main_default, &lv_font_montserratMedium_25);
