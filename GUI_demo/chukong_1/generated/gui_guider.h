...
typedef struct
{
	...
	lv_obj_t *clock_screen_spangroup_2;
	lv_span_t *clock_screen_spangroup_2_span;
	lv_obj_t *clock_screen_spangroup_1;
	lv_span_t *clock_screen_spangroup_1_span;
	...
	lv_obj_t *novel_list_list_1_item0;
	lv_obj_t *novel_list_list_1_item1;
	lv_obj_t *novel_list_list_1_item2;
