...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen, 240, 284);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_1, lv_color_hex(0x14ff00), LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_1, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 88, 25);
