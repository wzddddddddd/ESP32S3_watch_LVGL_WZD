...
void setup_scr_menu_screen(lv_ui *ui)
{
    ...
    ui->menu_screen_list_1_item3 = lv_list_add_btn(ui->menu_screen_list_1, &_image_alpha_30x30, "视频");
    ui->menu_screen_list_1_item4 = lv_list_add_btn(ui->menu_screen_list_1, &game, "游戏");
    ...
    lv_style_set_text_font(&style_menu_screen_list_1_extra_btns_main_default, &songti_font_16);
    ...
    lv_obj_add_style(ui->menu_screen_list_1_item3, &style_menu_screen_list_1_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_add_style(ui->menu_screen_list_1_item4, &style_menu_screen_list_1_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_style_set_text_font(&style_menu_screen_list_1_extra_texts_main_default, &songti_font_16);
